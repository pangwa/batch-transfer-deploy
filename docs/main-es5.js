(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        _createClass(MetaSenderComponent, [{
          ...
          value: function ngOnInit() {
            ...
            var sub = obContract.subscribe(function (data) {
              _this7.ownerAccount = data.owner;
            ...
            this.$subToken = obContract.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["combineLatest"])(obToken), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["switchMap"])(function (_ref) {
              ...
              _this7.ownerAccount = transferData.owner;
          ...
          value: function loadFileContent(file) {
            ...
            this.$subFile = this.readFile(file).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["map"])(function (content) {
              ...
              _this11.setAddressess(addresses);
            }, function (err) {
              _this11.setStatus('读取文件失败');
          ...
          value: function doTransfer() {
            ...
            var amounts = lodash__WEBPACK_IMPORTED_MODULE_5__["map"](this.addresses, function (addr) {
              return _this12.convertAmountToRaw(addr.amount);
            });
            ...
            ret.on('transactionHash', function (tx) {
              return _this12.loadingService.setTx(tx);
            });
            ret.then(function (tx) {
              console.log('updating transaction', tx.tx);

              _this12.loadingService.setTx('');

              _this12.loadingService.removeLoading();

              _this12.setStatus('发送交易成功');

              _this12.setAddressess([]);

              _this12.fileName = null;
            })["catch"](function (ex) {
              _this12.loadingService.setTx('');

              _this12.loadingService.removeLoading();

              _this12.setStatus('发送交易失败');
          ...
          value: function firstInvalidAccount() {
            ...
            return lodash__WEBPACK_IMPORTED_MODULE_5__["find"](this.addresses, function (account) {
              return !_this13.isAddressValid(account.address);
            });
          }
        }, {
    ...
    /***/
    function vYhm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
